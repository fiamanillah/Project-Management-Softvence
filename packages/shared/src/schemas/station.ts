...
export function isIpInCidr(clientIp: string, pattern: string): boolean {
  ...
  const cIp = normalizeIpAddress(clientIp)
...
export const createStationSchema = z.object({
  name: z
    .string()
    .min(2, "Station name is required and must be at least 2 characters"),
  code: z
    .string()
...
export const createProfileWithStationsSchema = z.object({
  username: z
    .string()
    .min(2, "Profile username is required and must be at least 2 characters"),
...
export const updateProfileWithStationsSchema = z.object({
  username: z
    .string()
    .min(2, "Profile username must be at least 2 characters")
    .optional(),
...
export const assignProfileToStationsSchema = z.object({
  stationIds: z
    .array(z.string().uuid("Invalid station ID"))
...
export type CreateProfileWithStationsDTO = z.input<
  typeof createProfileWithStationsSchema
>
export type UpdateProfileWithStationsDTO = z.input<
  typeof updateProfileWithStationsSchema
>
export type AssignProfileToStationsDTO = z.input<
  typeof assignProfileToStationsSchema
>
