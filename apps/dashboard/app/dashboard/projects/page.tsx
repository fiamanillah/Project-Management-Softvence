...
import { ManageProjectWorkspace } from "./components/manage-workspace/ManageProjectWorkspace";
...
function ProjectsContent() {
  ...
  // Main Page Tab: "manage" (Telegram Workspace) | "directory" (Table / Grid Directory)
  const [activeMainTab, setActiveMainTab] = React.useState<"manage" | "directory">("manage");
  const [activeWorkspaceProjectId, setActiveWorkspaceProjectId] = React.useState<string | null>(null);
    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Coordinate deliverables, real-time discussions, team allocations, and client accounts
            </p>
          </div>
        </div>

        {/* View Switcher Tabs (Manage Workspace vs Directory) & Actions */}
      ...
      {activeMainTab === "manage" ? (
        <ManageProjectWorkspace
          initialProjectId={activeWorkspaceProjectId}
          onNewProject={handleOpenCreateRoot}
        />
      ) : (
