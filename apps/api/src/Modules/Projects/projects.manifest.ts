...
export const projectsPermissions: PermissionManifestItem[] = [
  ...
  },
  {
    ...
    module: "Project Messaging",
    description: "Review, approve, and request revisions on outbound client communications in review",
    supportedScopes: SCOPE_PRESETS.PROJECT_HIERARCHICAL,
    implies: ["project.chat.view", "project.view"],
  },
  {
    code: "project.approval.auto_approve",
    module: "Project Messaging",
    description: "Outbound messages drafted by this role automatically bypass In Review and go straight to Awaiting Dispatch",
    supportedScopes: SCOPE_PRESETS.PROJECT_HIERARCHICAL,
    implies: ["project.approval.lead_review", "project.chat.send_client", "project.chat.view", "project.view"],
  },
  {
    code: "project.approval.sales_dispatch",
    module: "Project Messaging",
    description: "Dispatch approved client messages to external platforms (Fiverr, Upwork, Slack, etc.) and confirm delivery",
    supportedScopes: SCOPE_PRESETS.PROJECT_HIERARCHICAL,
    implies: ["project.chat.view", "project.view"],
  },
  {
